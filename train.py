...
class TrainingArguments(transformers.TrainingArguments):
    ...
    fp16: bool = field(default=True, metadata={"help": "Whether to use 16-bit (mixed) precision (through NVIDIA apex) instead of 32-bit"})
...
def train():
    ...
    if training_args.fsdp:
        training_args.fsdp_config = { "transformer_layer_cls_to_wrap": "LLaMADecoderLayer" }
